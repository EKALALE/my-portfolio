    ...
    <section id="projects" className="py-20 px-8 bg-gray-700">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        <div className="bg-gray-800 p-6 rounded-xl shadow hover:shadow-lg transition">
          <h3 className="text-xl font-semibold mb-2 text-red-200">BudgetEase</h3>
          <p className="text-gray-400">A budget management app built using React, Express, and MongoDB.</p>
        </div>
        <div className="bg-gray-800 p-6 rounded-xl shadow hover:shadow-lg transition">
          <h3 className="text-xl font-semibold mb-2 text-red-200">Meal Finder</h3>
          <p className="text-gray-400">A recipe search app using the MealDB API built with React and Tailwind.</p>
        </div>
        <div className="bg-gray-800 p-6 rounded-xl shadow hover:shadow-lg transition">
          <h3 className="text-xl font-semibold mb-2 text-red-200">E-commerce DB</h3>
          <p className="text-gray-400">A backend project showcasing relational database design in MySQL.</p>
        </div>
        <div className="bg-gray-800 p-6 rounded-xl shadow hover:shadow-lg transition">
          <h3 className="text-xl font-semibold mb-2 text-red-200">Bandits Surveillance System</h3>
          <p className="text-gray-400">A system that tracks and alert on criminals and bandits location ,time to attack,where and ways to mititgate the threat</p>
        </div>
      </div>
    </section>
  )
